    ...
    if len(sys.argv) == 1:
        ...
        match sys.argv[1]:
            ...
            case "config":
                ...
                confirm = input("Please confirm. This action will OVERWRITE any previous FlatWiki config files (if applicable)! Type 'overwrite' to continue with this DESTRUCTIVE action:")
